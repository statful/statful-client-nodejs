...
function overrideDefaultConfig(defaultConfig, overrideConfig) {
    if (overrideConfig) {
        ...
        if (overrideConfig.agg) {
            defaultConfig.agg = overrideConfig.agg;
        }

        if (overrideConfig.aggFreq) {
            defaultConfig.aggFreq = overrideConfig.aggFreq;
        }

        if (overrideConfig.tags) {
            defaultConfig.tags = overrideConfig.tags;
        }
    }
}
