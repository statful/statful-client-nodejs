 ...
 *          - agg: List of aggregations to be applied by the Telemetron. Ex: ['avg', 'p90', 'min']
...
Client.prototype.counter = function (name, value, parameters) {
    var counterValue = value || 1;

    putMetricType(this, this.default.counter, 'counter.' + name, counterValue, parameters);
};
