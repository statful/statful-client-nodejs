...
function putMetricType(self, metricTypeConf, name, value, parameters) {
    ...
    if (configHelper.areMetricTypesArgumentsValid(agg, aggFreq, tags)) {
        ...
        self.put(name, value, {tags: putTags, agg: putAgg, aggFreq: putAggFreq, sampleRate: metricParams.sampleRate, namespace: namespace});
    } else if (self.logger) {
 ...
 */
Client.prototype.time = function (name, timestamp, parameters) {
    putMetricType(this, this.default.timer, 'timer.' + name, timestamp, parameters);
};
