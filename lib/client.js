...
Client.prototype.time = function (name, value, tags, agg, aggFreq, namespace) {
    ...
    this.put('timer', merge({type: name, unit: 'ms'}, tags), value | 0, agg, aggFreq, this.sampleRate, namespace);
};
...
Client.prototype.inc = function (name, value, tags, agg, aggFreq, namespace) {
    ...
    this.put('counter', merge({type: name}, tags), value | 0, agg, aggFreq, this.sampleRate, namespace);
};
...
Client.prototype.gauge = function (name, value, tags, agg, aggFreq, namespace) {
    ...
    this.put('gauge', merge({type: name}, tags), value | 0, agg, aggFreq, this.sampleRate, namespace);
};
