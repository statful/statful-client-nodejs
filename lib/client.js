...
function putMetricType(self, metricTypeConf, name, value, tags, agg, aggFreq, namespace) {
    if (configHelper.areMetricTypesArgumentsValid(agg, aggFreq, tags)) {
        ...
        self.put(name, putTags, value, putAgg, putAggFreq, self.sampleRate, namespace);
    } else if (self.logger) {
...
Client.prototype.time = function (name, value, tags, agg, aggFreq, namespace) {
    putMetricType(this, this.default.timer, 'timer.' + name, value, tags, agg, aggFreq, namespace);
};
 ...
 * @param namespace Define the metric namespace. Default: application
 */
Client.prototype.counter = function (name, value, tags, agg, aggFreq, namespace) {
    putMetricType(this, this.default.counter, 'counter.' + name, value, tags, agg, aggFreq, namespace);
};
...
Client.prototype.gauge = function (name, value, tags, agg, aggFreq, namespace) {
    putMetricType(this, this.default.gauge, 'gauge.' + name, value, tags, agg, aggFreq, namespace);
};
 ...
 * @param namespace The namespace to prefix the metric name
 */
Client.prototype.put = function (metric, tags, value, agg, aggFreq, sample_rate, namespace) {
    if (!configHelper.areMetricTypesArgumentsValid(agg, aggFreq, tags)) {
        ...
        var metricName = putNamespace + '.' + metric,
            ...
            sampleRateNormalized = (sample_rate || 100) / 100;
...
Client.prototype.flush = function () {
    ...
    if (this.bufferSize > 0) {
        ...
        if (this.systemStats) {
            this.put('buffer.flush_length', {}, sizeToFlush, ['avg']);
        }
    }
};
