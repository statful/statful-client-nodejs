...
var Client = function (config) {
    ...
    this.autoDiagnostics = config.autoDiagnostics || true;
...
function performRequest(options) {
    return request(options, function callback(error, response, body) {
        if (error) {
        ...
        if (this.mock) {
            ...
            switch (this.transport) {
                ...
                case 'api':
                    ...
                    if (this.compression) {
                        sendCompressedMessage(options, message);
                    } else {
                        sendUncompressedMessage(options, message);
                    }
                    break;
            }
        }
